...
function Button({ 
  ...
  const baseStyles = 'inline-flex items-center justify-center rounded-xl font-semibold transition-all duration-200 font-family: Inter, sans-serif focus:outline-none focus:ring-2 focus:ring-offset-2'
  ...
  const variantStyles = {
    ...
    accent: 'bg-gradient-to-r from-[#40B1DF] to-[#3aa0c9] text-white hover:from-[#3aa0c9] hover:to-[#3590b8] shadow-md hover:shadow-lg transform hover:scale-105 focus:ring-[#40B1DF]',
