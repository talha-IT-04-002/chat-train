...
const USE_MOCK_API = import.meta.env.VITE_USE_MOCKS === 'true' || !import.meta.env.VITE_API_BASE_URL;
...
class ApiService {
  ...
  private async delegateToMock<T>(method: keyof typeof mockApiService, ...args: any[]): Promise<ApiResponse<T>> {
    return (mockApiService[method] as any)(...args);
  }
  ...
  public async uploadContentFiles(files: File[], extraFields?: Record<string, string>): Promise<ApiResponse<{ files: Array<{ filename: string; path: string; mimetype: string; size: number; originalName: string; publicUrl: string }> }>> {
    if (this.useMock) {
      return this.delegateToMock<{ files: Array<{ filename: string; path: string; mimetype: string; size: number; originalName: string; publicUrl: string }> }>('uploadContentFiles', files, extraFields);
    }
  ...
  public async login(email: string, password: string): Promise<ApiResponse<LoginResponse>> {
    if (this.useMock) {
      return this.delegateToMock<LoginResponse>('login', email, password);
    }
  ...
  public async register(userData: {
    ...
    if (this.useMock) {
      return this.delegateToMock<LoginResponse>('register', userData);
    }
  ...
  public async getCurrentUser(): Promise<ApiResponse<{ user: User; organizations: Organization[] }>> {
    if (this.useMock) {
      return this.delegateToMock<{ user: User; organizations: Organization[] }>('getCurrentUser');
    }
  ...
  public async getTrainers(organizationId?: string): Promise<ApiResponse<Trainer[]>> {
    if (this.useMock) {
      return this.delegateToMock<Trainer[]>('getTrainers', organizationId);
    }
  ...
  public async getTrainer(id: string): Promise<ApiResponse<Trainer>> {
    if (this.useMock) {
      return this.delegateToMock<Trainer>('getTrainer', id);
    }
  ...
  public async createTrainer(trainerData: {
    ...
    if (this.useMock) {
      return this.delegateToMock<Trainer>('createTrainer', trainerData);
    }
  ...
  public async updateTrainer(id: string, trainerData: Partial<Trainer>): Promise<ApiResponse<Trainer>> {
    if (this.useMock) {
      return this.delegateToMock<Trainer>('updateTrainer', id, trainerData);
    }
    return this.request<Trainer>(`/trainers/${id}`, {
      method: 'PUT',
      body: JSON.stringify(trainerData),
  ...
  public async deleteTrainer(id: string): Promise<ApiResponse> {
    if (this.useMock) {
      return this.delegateToMock('deleteTrainer', id);
    }
  ...
  public async getApiKeys(organizationId: string): Promise<ApiResponse<ApiKey[]>> {
    if (this.useMock) {
      return this.delegateToMock<ApiKey[]>('getApiKeys', organizationId);
    }
  ...
  public async createApiKey(apiKeyData: {
    ...
    if (this.useMock) {
      return this.delegateToMock<ApiKey>('createApiKey', apiKeyData);
    }
  ...
  public async getSessions(organizationId?: string): Promise<ApiResponse<Session[]>> {
    if (this.useMock) {
      return this.delegateToMock<Session[]>('getSessions', organizationId);
    }
    const params = organizationId ? `?organizationId=${organizationId}` : '';
  ...
  public async getAnalytics(organizationId: string, filters?: any): Promise<ApiResponse<any>> {
    if (this.useMock) {
      return this.delegateToMock<any>('getAnalytics', organizationId, filters);
    }
  ...
  public async healthCheck(): Promise<ApiResponse> {
    if (this.useMock) {
      return this.delegateToMock('healthCheck');
    }
