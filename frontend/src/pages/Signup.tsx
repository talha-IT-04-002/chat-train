      ...
      <div className="w-full lg:w-1/2 flex items-center p-4 lg:p-8 relative overflow-hidden">
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="hidden lg:block mb-6 text-center">
            <h2 className="text-3xl font-bold text-[#313F4E] dark:text-white mb-2">
              Create your account
            </h2>
            <p className="text-[#64748b] dark:text-gray-400">
              Start your AI-powered chat training journey
            </p>
          </div>
          ...
          <div className="p-6 transition-all duration-300">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <User className="h-5 w-5 text-[#64748b] group-focus-within:text-[#40B1DF] transition-colors duration-300" />
                  </div>
                  <input
                    type="text"
                    name="firstName"
                    ...
                    className={`w-full pl-10 pr-4 py-3 border rounded-2xl text-[#313F4E] dark:text-white placeholder-[#64748b] dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#40B1DF] focus:border-transparent transition-all duration-300 bg-white/50 dark:bg-gray-800/70 backdrop-blur-sm group-hover:bg-white dark:group-hover:bg-gray-800 ${
                      errors.firstName ? 'border-red-300 dark:border-red-600' : 'border-[#e2e8f0] dark:border-gray-700'
                    }`}
                  />
                </div>
                {errors.firstName && (
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-4 py-3 border rounded-2xl text-[#313F4E] dark:text-white placeholder-[#64748b] dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#40B1DF] focus:border-transparent transition-all duration-300 bg-white/50 dark:bg-gray-800/70 backdrop-blur-sm group-hover:bg-white dark:group-hover:bg-gray-800 ${
                      errors.lastName ? 'border-red-300 dark:border-red-600' : 'border-[#e2e8f0] dark:border-gray-700'
                    }`}
                  />
                </div>
                {errors.lastName && (
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-4 py-3 border rounded-2xl text-[#313F4E] dark:text-white placeholder-[#64748b] dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#40B1DF] focus:border-transparent transition-all duration-300 bg-white/50 dark:bg-gray-800/70 backdrop-blur-sm group-hover:bg-white dark:group-hover:bg-gray-800 ${
                      errors.email ? 'border-red-300 dark:border-red-600' : 'border-[#e2e8f0] dark:border-gray-700'
                    }`}
                  />
                </div>
                {errors.email && (
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-10 py-3 border rounded-2xl text-[#313F4E] dark:text-white placeholder-[#64748b] dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#40B1DF] focus:border-transparent transition-all duration-300 bg-white/50 dark:bg-gray-800/70 backdrop-blur-sm group-hover:bg-white dark:group-hover:bg-gray-800 ${
                      errors.password ? 'border-red-300 dark:border-red-600' : 'border-[#e2e8f0] dark:border-gray-700'
                    }`}
                  />
                  <button
                    type="button"
              ...
              <div>
                ...
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <Building className="h-5 w-5 text-[#64748b] group-focus-within:text-[#40B1DF] transition-colors duration-300" />
                  </div>
                  <input
                    type="text"
                    ...
                    className="w-full pl-10 pr-4 py-3 border border-[#e2e8f0] dark:border-gray-700 rounded-2xl text-[#313F4E] dark:text-white placeholder-[#64748b] dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#40B1DF] focus:border-transparent transition-all duration-300 bg-white/50 dark:bg-gray-800/70 backdrop-blur-sm group-hover:bg-white dark:group-hover:bg-gray-800"
                  />
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                <input
                  ...
                  className="h-4 w-4 text-[#40B1DF] focus:ring-[#40B1DF] border-[#e2e8f0] rounded transition-all duration-300 mt-1"
                />
                <label htmlFor="terms" className="text-sm text-[#64748b] leading-relaxed">
                  I agree to the{' '}
                  <Link to="#" className="text-[#40B1DF] hover:text-[#3aa0c9] font-medium transition-colors duration-300 hover:underline">
                    Terms of Service
                  </Link>{' '}
                  and{' '}
                  <Link to="#" className="text-[#40B1DF] hover:text-[#3aa0c9] font-medium transition-colors duration-300 hover:underline">
